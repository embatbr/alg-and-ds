...
void main() {
    ...
    hash_object = create_hash_object(1, 'x', "ic", hash_code(1, 9, 0));
    show_hash_object(hash_object);

    printf("\nCreating hash_object with key 1, value 120 and types \"ic\"\n");
    hash_object = create_hash_object(1, 120, "ic", hash_code(1, 9, 0));
    show_hash_object(hash_object);

    printf("\nCreating hash_object with key 'a', value 'x' and types \"cc\"\n");
    hash_object = create_hash_object('a', 'x', "cc", hash_code('a', 9, 0));
    show_hash_object(hash_object);

    printf("\nCreating hash_object with key 97, value 120 and types \"cc\"\n");
    hash_object = create_hash_object(97, 120, "cc", hash_code(97, 9, 0));
    show_hash_object(hash_object);
    ...
    int code = put(hash_table, 1, 120, "ii");
    printf("code: %d\n", code);
    show_hash_table(hash_table);

    printf("\nInserting (1, 'x', \"ic\") into hash_table\n");
    code = put(hash_table, 1, 'x', "ic");
    printf("code: %d\n", code);
    show_hash_table(hash_table);

    printf("\nInserting (1, 120, \"ic\") into hash_table\n");
    code = put(hash_table, 1, 120, "ic");
    printf("code: %d\n", code);
    show_hash_table(hash_table);

    printf("\nInserting ('a', 'x', \"cc\") into hash_table\n");
    code = put(hash_table, 'a', 'x', "cc");
    printf("code: %d\n", code);
    show_hash_table(hash_table);

    printf("\nInserting (97, 120, \"cc\") into hash_table\n");
    code = put(hash_table, 97, 120, "cc");
    printf("code: %d\n", code);
    show_hash_table(hash_table);

    printf("\nInserting (10, 'x', \"ic\") into hash_table\n");
    code = put(hash_table, 10, 'x', "ic");
    printf("code: %d\n", code);
    show_hash_table(hash_table);

    printf("\nInserting (19, 'x', \"ic\") into hash_table\n");
    code = put(hash_table, 19, 'x', "ic");
    printf("code: %d\n", code);
    show_hash_table(hash_table);
